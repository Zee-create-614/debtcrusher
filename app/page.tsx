        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "How does the money-back guarantee work?", a: "We guarantee at least 1 item removed from your credit report within 60 days. If not a single disputed item is removed, you get a full $7.99 refund. Simply come back to our Verify Results page, upload your updated credit report, and if zero items were removed, claim your refund instantly." },
